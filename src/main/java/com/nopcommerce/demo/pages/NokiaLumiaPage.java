...
public class NokiaLumiaPage extends Utility {
    ...
    public void clickOnCartBtn() {
        ...
        log.info("Click on Cart button ".toString() + "<br>");
    }
    ...
    public void verifyShoppingCartMessage(String expectedMessage) {
        ...
        log.info("Verify Shopping Cart Message " + expectedMessage.toString());
    }

    public void clickOnGreenBtn() {
        clickOnElement(greenBtnClick);
        log.info("Click on Green button ".toString() + "<br>");
    }
    ...
    public void clickOnGoToCart() {
        ...
        log.info("Click on Go To Cart button ".toString());
    }
