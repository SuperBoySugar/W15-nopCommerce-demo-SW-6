...
public class BuildYourOwnComputerPage extends Utility {
    ...
    public void verifyBuildYourOwnComputerText(String expectedMessage) {
        ...
        log.info("Verify Build your own computer Text: " + expectedMessage.toString());
    ...
    public void selectSoftware(String software1) {
        ...
        log.info("Select Software: " + software1.toString());
    }
    ...
    public void verifyAddToCartMessage(String expectedMessage) {
        ...
        log.info("Verify Add to Cart message: " + expectedMessage.toString());
    ...
    public void clickOnCrossButton() {
        ...
        log.info("Click on Cross button ".toString());
    ...
    public void mouseHoverOnShoppingCart() {
        ...
        log.info("Mouse hover on Shopping Cart ".toString());
    ...
    public void clickOnGoToCart() {
        ...
        log.info("Click on Go To Cart ".toString());
